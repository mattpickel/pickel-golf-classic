...
const LayfansTerms: React.FC = () => {
    return (
        <>
            <PageHeader annualNumber={6} title="LayFan's Terms" />
            <div className="content-panel">
                <div className="max-w-2xl mx-auto px-6 py-12">
                    <div className="flex flex-col sm:flex-row items-center gap-6 mb-8">
                        <img src="/images/layfans.PNG" alt="Layfan's Terms" className="w-32 sm:w-40 rounded" />
                        <div className="text-center sm:text-left">
                            <p className="font-display font-semibold text-2xl text-text-dark mb-3">
                                Find us on your preferred podcast platform!
                            </p>
                    ...
                    <div className="space-y-4 font-display text-xl text-text-dark leading-relaxed">
                        <p>
